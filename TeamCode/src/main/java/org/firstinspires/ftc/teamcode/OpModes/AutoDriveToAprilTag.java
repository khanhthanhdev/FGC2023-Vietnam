...
public class AutoDriveToAprilTag extends LinearOpMode
{
    ...
    private DcMotor leftFront   = null;  //  Used to control the left drive wheel
    private DcMotor leftBack = null;
    private DcMotor rightFront  = null;  //  Used to control the right drive wheel
    ...
    @Override public void runOpMode()
    {
        ...
        while (opModeIsActive())
        {
            ...
            if (gamepad1.touchpad && targetFound) {
