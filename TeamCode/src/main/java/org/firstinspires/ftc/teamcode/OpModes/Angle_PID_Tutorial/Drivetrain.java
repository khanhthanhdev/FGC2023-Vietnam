...
public class Drivetrain {
    ...
    public void init(HardwareMap ahwMap) {
        ...
        // Control HUb
        topLeftDriveMotor = hwMap.get(DcMotor.class, "leftFront");
        bottomLeftDriveMotor = hwMap.get(DcMotor.class, "leftBack");
        topRightDriveMotor = hwMap.get(DcMotor.class, "rightFront");
        bottomRightDriveMotor = hwMap.get(DcMotor.class, "rightBack");
